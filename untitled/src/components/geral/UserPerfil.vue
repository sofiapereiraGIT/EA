    ...
    <div>
        <div class="w3-row w3-padding-32 w3-section" style="padding-bottom:50px; padding-left: 50px; padding-right: 50px;">
            <div class="w3-col m6 w3-container">
                <img v-if="UserInfo.fotografia===null || UserInfo.fotografia===''" src="../../assets/user.png" style="margin-bottom: 10px" class="img w3-image">
                <img v-else :src="require('../../../img/'+UserInfo.fotografia)" style="margin-bottom: 10px" class="img w3-image">
                <br>
