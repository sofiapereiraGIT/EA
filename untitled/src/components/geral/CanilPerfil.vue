    ...
    <div class="w3-container w3-card w3-light-blue" style="margin-top: 10em; margin-bottom:10em; margin-left: 5em; margin-right: 5em;">
       <div class="w3-row w3-section">
            <div class="w3-col m6 w3-container">
                <img v-if="utilizador.fotografia===null || utilizador.fotografia==='' || utilizador.fotografia==='null'" src="../../../img/userCanis.png" style="margin-bottom: 10px" class="img w3-image">
