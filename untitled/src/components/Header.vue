<template>
    <div class="w3-top">
        ...
        <div class="w3-bar" id="myNavbar">
            ...
            <a href="#home" class="w3-bar-item w3-button" style="float:left">HOME</a>
            ...
            <a href="#canis" class="w3-bar-item w3-button w3-hide-small" style="float:right"><i class="fa fa-home"></i> CANIS</a>
        </div>
    </div>
</template>
