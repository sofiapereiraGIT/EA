...
public class PedidoDAO {
	...
	public static Pedido loadPedidoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Pedido) session.load(Pedido.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Pedido getPedidoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Pedido) session.get(Pedido.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Pedido loadPedidoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Pedido) session.load(Pedido.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Pedido getPedidoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Pedido) session.get(Pedido.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryPedido(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Pedido as Pedido");
		if (condition != null)
	...
	public static boolean save(Pedido pedido) throws PersistentException {
		try {
	...
	public static boolean delete(Pedido pedido) throws PersistentException {
		try {
	...
	public static boolean refresh(Pedido pedido) throws PersistentException {
		try {
	...
	public static boolean evict(Pedido pedido) throws PersistentException {
		try {
