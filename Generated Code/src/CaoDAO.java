...
public class CaoDAO {
	...
	public static Cao loadCaoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Cao) session.load(Cao.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Cao getCaoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Cao) session.get(Cao.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Cao loadCaoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Cao) session.load(Cao.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Cao getCaoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Cao) session.get(Cao.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryCao(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Cao as Cao");
		if (condition != null)
	...
	public static boolean save(Cao cao) throws PersistentException {
		try {
	...
	public static boolean delete(Cao cao) throws PersistentException {
		try {
	...
	public static boolean refresh(Cao cao) throws PersistentException {
		try {
	...
	public static boolean evict(Cao cao) throws PersistentException {
		try {
