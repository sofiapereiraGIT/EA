...
public class AnimalPerdidoDAO {
	...
	public static AnimalPerdido loadAnimalPerdidoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (AnimalPerdido) session.load(AnimalPerdido.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static AnimalPerdido getAnimalPerdidoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (AnimalPerdido) session.get(AnimalPerdido.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static AnimalPerdido loadAnimalPerdidoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (AnimalPerdido) session.load(AnimalPerdido.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static AnimalPerdido getAnimalPerdidoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (AnimalPerdido) session.get(AnimalPerdido.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryAnimalPerdido(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From AnimalPerdido as AnimalPerdido");
		if (condition != null)
	...
	public static AnimalPerdido createAnimalPerdido() {
		return new AnimalPerdido();
	}
	
	public static boolean save(AnimalPerdido animalPerdido) throws PersistentException {
		try {
	...
	public static boolean delete(AnimalPerdido animalPerdido) throws PersistentException {
		try {
	...
	public static boolean refresh(AnimalPerdido animalPerdido) throws PersistentException {
		try {
	...
	public static boolean evict(AnimalPerdido animalPerdido) throws PersistentException {
		try {
