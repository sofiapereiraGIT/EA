...
public class AnimalDAO {
	...
	public static Animal loadAnimalByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Animal) session.load(Animal.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Animal getAnimalByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Animal) session.get(Animal.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Animal loadAnimalByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Animal) session.load(Animal.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Animal getAnimalByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Animal) session.get(Animal.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryAnimal(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From Animal as Animal");
		if (condition != null)
	...
	public static boolean save(Animal animal) throws PersistentException {
		try {
	...
	public static boolean delete(Animal animal) throws PersistentException {
		try {
	...
	public static boolean refresh(Animal animal) throws PersistentException {
		try {
	...
	public static boolean evict(Animal animal) throws PersistentException {
		try {
