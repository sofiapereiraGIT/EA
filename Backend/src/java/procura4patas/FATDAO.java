...
public class FATDAO {
	...
	public static FAT loadFATByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (FAT) session.load(procura4patas.FAT.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static FAT getFATByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (FAT) session.get(procura4patas.FAT.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static FAT loadFATByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (FAT) session.load(procura4patas.FAT.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static FAT getFATByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (FAT) session.get(procura4patas.FAT.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryFAT(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From procura4patas.FAT as FAT");
		if (condition != null)
	...
	public static FAT createFAT() {
		return new procura4patas.FAT();
	}
	
	public static boolean save(procura4patas.FAT fAT) throws PersistentException {
		try {
	...
	public static boolean delete(procura4patas.FAT fAT) throws PersistentException {
		try {
	...
	public static boolean refresh(procura4patas.FAT fAT) throws PersistentException {
		try {
	...
	public static boolean evict(procura4patas.FAT fAT) throws PersistentException {
		try {
