...
public class Procura4patasPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Procura4patas";
	...
	private Procura4patasPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Procura4patasPersistentManager();
		}
