...
public class UtilizadorDAO {
	...
	public static List queryUtilizador(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From procura4patas.Utilizador as Utilizador");
		if (condition != null)
	...
	public static Utilizador createUtilizador() {
		return new procura4patas.Utilizador();
	}
	
	public static boolean save(procura4patas.Utilizador utilizador) throws PersistentException {
		try {
			Procura4patasPersistentManager.instance().saveObject(utilizador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(procura4patas.Utilizador utilizador) throws PersistentException {
		try {
			Procura4patasPersistentManager.instance().deleteObject(utilizador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(procura4patas.Utilizador utilizador) throws PersistentException {
		try {
			Procura4patasPersistentManager.instance().getSession().refresh(utilizador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(procura4patas.Utilizador utilizador) throws PersistentException {
		try {
			Procura4patasPersistentManager.instance().getSession().evict(utilizador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
