...
public class AdocaoDAO {
	...
	public static Adocao loadAdocaoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Adocao) session.load(procura4patas.Adocao.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Adocao getAdocaoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Adocao) session.get(procura4patas.Adocao.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Adocao loadAdocaoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Adocao) session.load(procura4patas.Adocao.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Adocao getAdocaoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Adocao) session.get(procura4patas.Adocao.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryAdocao(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From procura4patas.Adocao as Adocao");
		if (condition != null)
	...
	public static Adocao createAdocao() {
		return new procura4patas.Adocao();
	}
	
	public static boolean save(procura4patas.Adocao adocao) throws PersistentException {
		try {
	...
	public static boolean delete(procura4patas.Adocao adocao) throws PersistentException {
		try {
	...
	public static boolean refresh(procura4patas.Adocao adocao) throws PersistentException {
		try {
	...
	public static boolean evict(procura4patas.Adocao adocao) throws PersistentException {
		try {
