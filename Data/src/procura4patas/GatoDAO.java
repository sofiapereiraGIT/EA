...
public class GatoDAO {
	...
	public static Gato loadGatoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Gato) session.load(procura4patas.Gato.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Gato getGatoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Gato) session.get(procura4patas.Gato.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Gato loadGatoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Gato) session.load(procura4patas.Gato.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Gato getGatoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Gato) session.get(procura4patas.Gato.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryGato(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From procura4patas.Gato as Gato");
		if (condition != null)
	...
	public static Gato createGato() {
		return new procura4patas.Gato();
	}
	
	public static boolean save(procura4patas.Gato gato) throws PersistentException {
		try {
	...
	public static boolean delete(procura4patas.Gato gato) throws PersistentException {
		try {
	...
	public static boolean refresh(procura4patas.Gato gato) throws PersistentException {
		try {
	...
	public static boolean evict(procura4patas.Gato gato) throws PersistentException {
		try {
